...
if (isset($_POST['submit'])) {
	...
	$ret = ("SELECT * FROM users WHERE email='" . $_POST['username'] . "' and password='" .$_POST['password'] . "'");
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				...
				<br> <br>
				<h2 style="font-weight:bold;"> Mpeketoni Hospital | Patient Login</h2>
			</div>
			...
			<div class="box-login">
				<form class="form-login" method="post">
					<fieldset>
						...
						<div class="form-actions">
							<a href="../index.html" class="btn btn-primary pull-left">
								Go Home <i class="fa fa-arrow-circle-left"></i>
							</a>
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> Mpeketoni Hospital Management System</span>. <span>All rights reserved</span>
				</div>
